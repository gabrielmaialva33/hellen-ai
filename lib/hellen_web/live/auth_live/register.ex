defmodule HellenWeb.AuthLive.Register do
    ...
    if socket.assigns[:current_user] do
      ...
      {:ok,
       assign(socket,
         ...
         page_subtitle: "Comece sua jornada com a Hellen AI"
       )}
    end
  end
  ...
  def render(assigns) do
    ~H"""
    <form action={~p"/session/register"} method="post" class="space-y-5">
      ...
      <p class="text-xs text-center text-gray-500 dark:text-gray-400">
        ...
        <a href="#" class="text-indigo-600 dark:text-indigo-400 hover:underline">Termos de Uso</a>
        e
