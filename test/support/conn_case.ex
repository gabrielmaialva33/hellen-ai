defmodule HellenWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use HellenWeb.ConnCase, async: true`, although
  ...
  def register_and_log_in_user(%{conn: conn}) do
    user = Hellen.Factory.insert(:user)
  ...
  @doc """
  Creates an authenticated connection with a new user.
  """
